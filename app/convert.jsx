  ...
  return (
    <SafeAreaView>
      <View className="bg-[#FFB783] h-full flex pt-12">
            ...
            <View className="flex flex-row items-center pb-4">
                ...
                <View className="ml-4 flex justify-center">
                    <View className="flex flex-row gap-2 items-center">
                        <Text className="font-pmedium text-[18px]">
                            BTC
                        </Text>
        ...
        <View className="flex flex-row flex-wrap mt-auto bg-white rounded-t-[40px] p-4 max-h-[385px] justify-center z-20">
