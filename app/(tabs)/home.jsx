    ...
    <SafeAreaView>
      ...
      <View className="w-full h-full">
        <View className="flex-1 bg-pink-100">
          ...
          <View className="px-8 relative mt-8">
            <View className="z-20">
              ...
              <TouchableOpacity 
                ...
                activeOpacity={0.7}
              >
                <Text className="font-psemibold text-[14px]">Learn more</Text>
              </TouchableOpacity>
            </View>
          ...
          <View className="bg-gray-100 px-8 py-8 mt-12 rounded-t-[40px] h-full">
            <View className="flex flex-row gap-7" style={{ flexWrap: 'wrap' }}>
              {helpers.map((btn, index) => (
                <TouchableOpacity 
                  className="flex flex-row h-[54px] w-[155px] bg-white rounded-full items-center"
                  activeOpacity={0.7}
                  key={index}
                  onPress={() => router.push(btn.url)}
                >
                  <Image 
                    source={btn.icon}
                    className="m-3"
                  />
                  <Text className="mt-1 font-pmedium text-[14px]">
                    {btn.label}
                  </Text>
                </TouchableOpacity>
              ))}
            ...
            <View className="mt-8">
              <Text className="font-pmedium text-[20px]">Trending</Text>
