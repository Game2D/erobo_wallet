...
const CryptoCard = ({ icon, leftTitle, leftSubtitle, rightTitle, rightSubtitle, rightRate, leftRate, graphicImg, id, onPress }) => {
  return (
    <TouchableOpacity 
        onPress={onPress}
        activeOpacity={0.7}
        ...
        <View className="justify-between items-center flex flex-row h-[70px]">
            <View className="flex flex-row">
                ...
                <View className="justify-center ml-4">
                    <Text className="font-pmedium text-[18px]">{leftTitle}</Text>
            ...
            <View className="flex justify-center items-end">
                <Text className="text-[18px] font-pmedium">{rightTitle}</Text>
